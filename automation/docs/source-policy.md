...
- Extract high-level themes or patterns.
- Use short quotes with attribution.
- Summarize content to support analysis.

## Not allowed

- Full-site paraphrase or rewrite without explicit permission.
- Copying large sections of text into drafts.
