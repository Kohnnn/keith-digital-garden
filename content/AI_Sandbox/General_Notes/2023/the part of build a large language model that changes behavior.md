---
title: the part of build a large language model that changes behavior
tags:
  - general-note
  - ai
  - 2023
...
<div class="inline-ref">
  ...
  <a class="ref-link external" href="https://www.manning.com/books/build-a-large-language-model-from-scratch" rel="nofollow"><span class="indicator-hook"></span>www.manning.com</a>
  <span class="ref-title">Build a Large Language Model (From Scratch)</span>
  <span class="ref-meta">2023-12-31</span>
</div>

I read build a large language model as a constraint signal more than novelty. The link is just the anchor; the mechanics are where the leverage is ([source](https://www.manning.com/books/build-a-large-language-model-from-scratch)).
