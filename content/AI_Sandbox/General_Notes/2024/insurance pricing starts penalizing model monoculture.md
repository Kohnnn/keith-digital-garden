---
title: insurance pricing starts penalizing model monoculture
tags:
  - generalnote
  - risk
  - insurance
...
Cyber and operational risk underwriting is increasingly sensitive to concentration exposure, where one vendor path can interrupt many business functions at once ([Marsh Cyber Reports](https://www.marsh.com/us/services/cyber-risk.html)). Premium logic now reflects dependency topology, not only incident history.
