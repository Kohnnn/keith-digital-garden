---
title: open source model audits become procurement baseline
tags:
  - generalnote
  - ai
  - security
...
Enterprise buyers increasingly require third-party risk audits before approving open-weight model deployments, especially for customer-facing workflows where governance exposure is high ([OWASP](https://owasp.org/www-project-top-10-for-large-language-model-applications/)).
