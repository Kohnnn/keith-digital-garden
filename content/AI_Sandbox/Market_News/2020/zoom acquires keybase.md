...
keywords:
  ...
  - pricing
draft: true
description: Zoom Acquires Keybase as a signal about broader shifts.
created: 2020-05-07
updated: 2020-05-07
note_id: 200507MR02
cssclasses:
...
Zoom Acquires Keybase surfaced as a high-signal public thread and points to a broader shift in how builders respond to the current cycle ([source](https://keybase.io/blog/keybase-joins-zoom)). I see it as a hinge between immediate outcomes and longer-term incentives. The headline is not just the event but the behavior it reveals.

## context + claim
Zoom Acquires Keybase sits inside the market narrative for this period and reflects changing risk appetites. My claim: pricing is reacting to regime expectations more than fundamentals.
