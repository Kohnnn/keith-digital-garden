...
<ul class="brain-dump">
  ...
  <li><strong>Power:</strong> The label lets me act quickly, which can be a gift or a trap.</li>
  <li><strong>Distance:</strong> The cleaner the concept, the easier it is to ignore the human cost.</li>
  <li><strong>Leak:</strong> A bad abstraction keeps leaking errors into real life.</li>
  <li><strong>Repair:</strong> I can return to the concrete without abandoning the idea.</li>
  <li><strong>Practice:</strong> I need to keep testing the concept against the world.</li>
  <li><strong>Tension:</strong> I want speed.</li>
  <li><strong>Tension:</strong> I need nuance.</li>
</ul>
...
<div class="linkage-tree">
  ...
  <ul>
    <li>definitions and clarity
      <ul>
        <li>[[Socrates - The Question That Bites]]</li>
      </ul>
    </li>
    <li>meaning and honesty
      <ul>
...
> Why it matters: a classic case for the reality of forms and ideas.

> [!ref] Abstract Objects (Stanford Encyclopedia of Philosophy)
> https://plato.stanford.edu/entries/abstract-objects/
> Why it matters: defines what it means for something to be abstract.

> [!ref] Plato: Theory of Forms (Philosophy Break)
> https://philosophybreak.com/articles/plato-theory-of-forms/
> Why it matters: a short, readable tour of abstraction and form.

> [!ref] Nonexistent Objects & Imaginary Worlds: Crash Course Philosophy #29 (transcript)
> https://nerdfighteria.info/v/Y7v2kESrqDQ/
> Why it matters: shows how language points beyond concrete things.
