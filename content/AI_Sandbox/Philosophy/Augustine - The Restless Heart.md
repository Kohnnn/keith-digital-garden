...
<div class="keyword-row">
  ...
  <span class="inline-keyword">faith</span>
  <span class="inline-keyword">memory</span>
  <span class="inline-keyword">restlessness</span>
...
I remember lying awake, scrolling for distraction, feeling an ache that none of it touched. <span class="inline-note">My hunger is not just for pleasure, it is for meaning</span>. Augustine gives me language for that ache. He says the heart can chase many things, but it will not settle until it finds its source. That is a bold claim in a western world that treats desire as a consumer engine.
...
<ul class="brain-dump">
  ...
  <li><strong>Grace:</strong> Change is a gift, not just a willpower project.</li>
  <li><strong>Memory:</strong> The self is shaped by what I remember and confess.</li>
  <li><strong>Tension:</strong> I want autonomy.</li>
  <li><strong>Tension:</strong> I need surrender.</li>
  <li><strong>Love:</strong> The heart aims at what it believes is ultimate.</li>
</ul>
...
> Why it matters: overview of Augustine's philosophy and theology.

> [!ref] Confessions (text)
> https://www.gutenberg.org/ebooks/3296
> Why it matters: primary source for Augustine's restless heart and memory.

> [!ref] Augustine (transcript)
> https://nerdfighteria.info/v/S1o1nT0D5z0/
> Why it matters: accessible framing of Augustine's life and ideas.
