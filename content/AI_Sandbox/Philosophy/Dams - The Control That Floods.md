...
<ul class="brain-dump">
  ...
  <li><strong>Cost:</strong> Control hides the bill instead of canceling it.</li>
  <li><strong>Power:</strong> The people who decide control are not always the ones affected.</li>
  <li><strong>Delay:</strong> A dam often postpones a problem rather than solving it.</li>
  <li><strong>Humility:</strong> The river is older than my plan.</li>
  <li><strong>Repair:</strong> Good control includes a way to undo itself.</li>
  <li><strong>Tension:</strong> I want safety.</li>
  <li><strong>Tension:</strong> I need flow.</li>
</ul>
...
> https://www.aldoleopold.org/land-ethic/a-sand-county-almanac/
> Why it matters: connects land, care, and the costs of human control.

> [!ref] Embalses - Pantans
> https://lab.marconoris.com/Sequere/Hipertext/Embalses+-+Pantans
> Why it matters: a local view of dams and their consequences.

> [!ref] 5 Human Impacts on the Environment: Crash Course Ecology #10 (transcript)
> https://nerdfighteria.info/v/5eTCZ9L834s/
> Why it matters: grounds control in real environmental impact.
