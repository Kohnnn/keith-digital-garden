...
<ul class="brain-dump">
  ...
  <li><strong>Tempo:</strong> Fast choices feel clean, but they hide the real cost.</li>
  <li><strong>Trade:</strong> I can buy speed, but I pay with stability.</li>
  <li><strong>Signal:</strong> If I have to hide details to sell the plan, the plan is weak.</li>
  <li><strong>Boundary:</strong> Prudence is what keeps my promises inside my limits.</li>
  <li><strong>Tension:</strong> I want speed.</li>
  <li><strong>Tension:</strong> I need stability.</li>
</ul>
...
> Why it matters: the core source for practical wisdom.

> [!ref] Virtue Ethics (1000-Word Philosophy)
> https://1000wordphilosophy.com/2022/02/06/virtue-ethics/
> Why it matters: a clean summary of the virtue approach.

> [!ref] Aristotle & Virtue Theory: Crash Course Philosophy #38 (transcript)
> https://nerdfighteria.info/v/PrvtOWEXDIQ/
> Why it matters: a modern walkthrough of the same ideas.

> [!ref] Aristotle's Ethics (Stanford Encyclopedia of Philosophy)
> https://plato.stanford.edu/entries/aristotle-ethics/
> Why it matters: context for how practical wisdom fits the system.
