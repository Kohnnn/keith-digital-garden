...
The tricky part is that extractivism often looks like progress. It looks like jobs, growth, and new comforts. That is what makes it hard to resist. The short warning that keeps me honest is this: <span class="inline-note">if the system needs emptiness to succeed, it will eventually empty me too</span>. When I see that, I can no longer pretend the cost is external. The cost is inside the story.
...
<ul class="brain-dump">
  ...
  <li><strong>Time:</strong> Fast gains usually hide slow losses.</li>
  <li><strong>People:</strong> Communities are harmed when the land is treated as disposable.</li>
  <li><strong>Self:</strong> I can be extractive with my own attention and energy.</li>
  <li><strong>Scale:</strong> The more I take, the smaller my future becomes.</li>
  <li><strong>Repair:</strong> The only antidote is reciprocity.</li>
  <li><strong>Tension:</strong> I want more now.</li>
  <li><strong>Tension:</strong> I need enough later.</li>
</ul>
...
> https://monthlyreview.org/product/open_veins_of_latin_america/
> Why it matters: a foundational account of extraction as historical pattern.

> [!ref] Extractivismo
> https://lab.marconoris.com/Sequere/Hipertext/Extractivismo
> Why it matters: a grounded, place-based map of extraction and damage.

> [!ref] Poverty & Our Response to It: Crash Course Philosophy #44 (transcript)
> https://nerdfighteria.info/v/D5sknLy7Smo/
> Why it matters: ties material systems to moral responsibility.
