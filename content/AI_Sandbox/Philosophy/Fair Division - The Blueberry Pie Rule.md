...
<ul class="brain-dump">
  ...
  <li><strong>Symmetry:</strong> Reversing roles exposes hidden bias.</li>
  <li><strong>Information:</strong> Fairness collapses when one side knows more.</li>
  <li><strong>Trust:</strong> Transparent processes earn trust faster than good intentions.</li>
  <li><strong>Scale:</strong> Small fairness habits shape big social systems.</li>
  <li><strong>Repair:</strong> If the rule fails, I need a better rule, not a better story.</li>
  <li><strong>Tension:</strong> I want advantage.</li>
...
<div class="linkage-tree">
  ...
  <ul>
    ...
    <li>truth and information
      <ul>
        <li>[[Epistemology - Thinking From the Floor]]</li>
      </ul>
    </li>
    <li>growth and conscience
      <ul>
...
> Why it matters: a classic link between justice and character.

> [!ref] La technique du decoupage de la tarte a la myrtille
> https://lelearner.com/Philosophie+%F0%9F%A4%94/la+technique+du+d%C3%A9coupage+de+la+tarte+%C3%A0+la+myrtille
> Why it matters: a small, practical rule that exposes fairness.

> [!ref] What Is Justice?: Crash Course Philosophy #40 (transcript)
> https://nerdfighteria.info/v/H0CTHVCkm90/
> Why it matters: a fast overview of fairness and justice.
