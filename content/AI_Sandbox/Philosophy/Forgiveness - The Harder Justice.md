...
<div class="keyword-row">
  <span class="inline-keyword">forgiveness</span>
  <span class="inline-keyword">justice</span>
  <span class="inline-keyword">mercy</span>
  <span class="inline-keyword">repair</span>
...
I remember a conversation that cracked a friendship. The words were sharp and true and cruel all at once. I felt the urge to cut the other person out of my life. That would have been easy. The harder path was to name the harm, keep the boundary, and still stay open to repair. <span class="inline-note">Forgiveness asks me to carry a boundary without carrying a grudge</span>. That is a different kind of strength than revenge. It is slow, and it costs.
...
<ul class="brain-dump">
  ...
  <li><strong>Truth:</strong> Naming the wound is part of the mercy.</li>
  <li><strong>Boundary:</strong> Letting go does not mean letting it happen again.</li>
  <li><strong>Tension:</strong> I want justice as punishment.</li>
  <li><strong>Tension:</strong> I want justice as transformation.</li>
  <li><strong>Time:</strong> Forgiveness is a process, not a moment.</li>
</ul>
...
<div class="linkage-tree">
  ...
  <ul>
    <li>mercy and justice
      <ul>
        <li>[[Christianity - The Wound That Heals]]</li>
        <li>[[Fair Division - The Blueberry Pie Rule]]</li>
      </ul>
    </li>
    <li>release and discipline
      <ul>
...
> Why it matters: primary source for forgiveness language and ethics.

> [!ref] The Book of Forgiving (book)
> https://www.harpercollins.com/products/the-book-of-forgiving-desmond-tutu-mpho-tutu
> Why it matters: practical and spiritual framework for repair.

> [!ref] Forgiveness (Stanford Encyclopedia of Philosophy)
> https://plato.stanford.edu/entries/forgiveness/
> Why it matters: conceptual clarity on what forgiveness is and is not.

> [!ref] Forgive and Forget (book)
> https://press.uchicago.edu/ucp/books/book/chicago/F/bo3684714.html
> Why it matters: philosophical argument for forgiveness with justice.
