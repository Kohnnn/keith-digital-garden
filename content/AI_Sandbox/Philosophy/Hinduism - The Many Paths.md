...
<div class="keyword-row">
  <span class="inline-keyword">dharma</span>
  <span class="inline-keyword">karma</span>
  <span class="inline-keyword">devotion</span>
...
I remember reading a story where the divine appears in many forms, and the forms do not cancel each other out. <span class="inline-note">Multiplicity does not have to mean confusion</span>. Hinduism teaches me that difference can be sacred. That is a powerful counter to the western habit of ranking everything in a single hierarchy. It does not mean anything goes. It means the path must fit the person while still pointing toward liberation.
...
<ul class="brain-dump">
  ...
  <li><strong>Karma:</strong> Actions leave residue that shapes the future.</li>
  <li><strong>Devotion:</strong> Love can be a form of knowledge.</li>
  <li><strong>Tension:</strong> I want freedom.</li>
  <li><strong>Tension:</strong> I need structure to reach it.</li>
  <li><strong>Liberation:</strong> The goal is release from grasping.</li>
</ul>
...
<div class="linkage-tree">
  ...
  <ul>
    <li>unity and multiplicity
      <ul>
        <li>[[Advaita Vedanta - The One Without Edges]]</li>
        <li>[[Samkhya - The Twofold Reality]]</li>
      </ul>
    </li>
    <li>duty and action
      <ul>
...
> Why it matters: primary source on duty and action.

> [!ref] The Upanishads (text)
> https://www.sacred-texts.com/hin/upan/index.htm
> Why it matters: core teachings on self and reality.

> [!ref] Hinduism (Stanford Encyclopedia of Philosophy)
> https://plato.stanford.edu/entries/hinduism/
> Why it matters: philosophical framing of diverse traditions.

> [!ref] Hinduism (Internet Encyclopedia of Philosophy)
> https://iep.utm.edu/hinduism/
> Why it matters: accessible overview of beliefs and practice.
