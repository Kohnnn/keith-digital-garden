...
<ul class="brain-dump">
  ...
  <li><strong>Limit:</strong> They show what can be said without saying what is.</li>
  <li><strong>Discipline:</strong> They keep me from hiding behind fuzzy language.</li>
  <li><strong>Risk:</strong> I can become obsessed with form and ignore lived meaning.</li>
  <li><strong>Slip:</strong> A perfect form can hide an empty claim.</li>
  <li><strong>Return:</strong> The world begins after the logic is set.</li>
  <li><strong>Tension:</strong> I want a clean frame.</li>
  <li><strong>Tension:</strong> I need lived meaning.</li>
</ul>
...
> Why it matters: a classic argument for the limits of sense and language.

> [!ref] Logical Truth (Stanford Encyclopedia of Philosophy)
> https://plato.stanford.edu/entries/logical-truth/
> Why it matters: a clear explanation of why tautologies are special.

> [!ref] Language & Meaning: Crash Course Philosophy #26 (transcript)
> https://nerdfighteria.info/v/zmwgmt7wcv8/
> Why it matters: connects logic to everyday meaning-making.
