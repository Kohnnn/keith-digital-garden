...
<div class="keyword-row">
  <span class="inline-keyword">ascent</span>
  <span class="inline-keyword">unity</span>
  <span class="inline-keyword">light</span>
  <span class="inline-keyword">emanation</span>
  <span class="inline-keyword">mysticism</span>
</div>
...
I remember looking up at a night sky and feeling an odd pull toward stillness. The stars were not speaking, but the silence felt like a call. <span class="inline-note">The highest reality feels more like clarity than noise</span>. Neoplatonism gives that feeling a map. It says the world is not random; it is a cascade. The task is to climb by reducing distraction.

> [!question] Reflective question
> What distraction am I clinging to that keeps me from ascent?

<ul class="brain-dump">
  <li><strong>Ascent:</strong> Life can move toward a deeper source.</li>
  <li><strong>Emanation:</strong> The many flow from the One.</li>
  <li><strong>Return:</strong> The soul can turn back toward origin.</li>
  <li><strong>Tension:</strong> I want grounded reality.</li>
  <li><strong>Tension:</strong> I want transcendence.</li>
  <li><strong>Practice:</strong> Clarity grows through simplification.</li>
</ul>
...
<div class="linkage-tree">
  ...
  <ul>
    <li>forms and ascent
      <ul>
        <li>[[Plato - The Cave I Keep Building]]</li>
    ...
    <li>unity and return
      <ul>
        ...
        <li>[[Madhyamaka - The Middle That Refuses]]</li>
      </ul>
    </li>
    <li>beauty and guidance
      <ul>
...
> Why it matters: overview of Neoplatonist metaphysics and ascent.

> [!ref] The Enneads (text)
> https://www.gutenberg.org/ebooks/42930
> Why it matters: primary source for the ascent and the One.

> [!ref] Neoplatonism (transcript)
> https://nerdfighteria.info/v/7r5o1wSZ1B0/
> Why it matters: accessible framing of Neoplatonist ideas.
