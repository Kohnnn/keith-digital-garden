...
<div class="keyword-row">
  <span class="inline-keyword">dao</span>
  <span class="inline-keyword">breath</span>
...
<ul class="brain-dump">
  ...
  <li><strong>Balance:</strong> Health is a relationship, not a target.</li>
  <li><strong>Ritual:</strong> The small acts shape the whole life.</li>
  <li><strong>Tension:</strong> I want results now.</li>
  <li><strong>Tension:</strong> I need patience to live well.</li>
  <li><strong>Softness:</strong> Yielding can be a form of strength.</li>
</ul>
...
> Why it matters: philosophical grounding for the way and practice.

> [!ref] Daoist Ritual (Oxford Research Encyclopedia)
> https://oxfordre.com/religion/display/10.1093/acrefore/9780199340378.001.0001/acrefore-9780199340378-e-410
> Why it matters: overview of ritual practice and community life.

> [!ref] The Tao Te Ching (text)
> https://ctext.org/dao-de-jing
> Why it matters: primary source for the way and its posture.

> [!ref] The Zhuangzi (text)
> https://ctext.org/zhuangzi
> Why it matters: stories and practices of softness and alignment.
