...
<div class="inline-ref">
  ...
  <a class="ref-link" href="https://motherduck.com/blog/big-data-is-dead/">motherduck.com</a>
  <span class="ref-title">Big data is dead</span>
</div>

Big data is dead is a pressure test for how this cycle behaves ([source](https://motherduck.com/blog/big-data-is-dead/)). I care less about the headline and more about the constraints it reveals. The interesting part is what defaults this makes feel inevitable.

## context + claim
big data is dead shifts the center of gravity toward a new default. My claim is simple: this is a habit-forming change, not a one-off event. If teams internalize the behavior, the market follows.
