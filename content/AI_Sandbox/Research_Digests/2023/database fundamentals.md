...
<div class="inline-ref">
  ...
  <a class="ref-link" href="https://tontinton.com/posts/database-fundementals/">tontinton.com</a>
  <span class="ref-title">Database Fundamentals</span>
</div>

Database Fundamentals lands as a clean signal for the current cycle ([source](https://tontinton.com/posts/database-fundementals/)). The point is not the news itself but the behavioral drift it exposes. I care about what becomes default after the dust settles.

## context + claim
database fundamentals shifts the center of gravity toward a new default. My claim is simple: this is a habit-forming change, not a one-off event. If teams internalize the behavior, the market follows.
