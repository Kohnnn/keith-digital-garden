...
## context + claim
The piece aggregates evidence around gpt-4, giving a snapshot of how the trend is moving. My claim: the data shows a structural shift that operators should treat as baseline, not a temporary spike.
