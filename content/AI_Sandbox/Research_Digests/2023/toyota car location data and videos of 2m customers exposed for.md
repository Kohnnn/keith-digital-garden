...
Toyota: Car location data and videos of 2M customers exposed for ten years is a reminder that the smallest shifts in defaults can carry the largest consequences ([source](https://www.bleepingcomputer.com/news/security/toyota-car-location-data-of-2-million-customers-exposed-for-ten-years/)). The visible change is just the entry point.

## context + claim
toyota: car location data and videos of 2m customers exposed for ten years shifts the center of gravity toward a new default. My claim: this is a habit-forming change, not a one-off event. If teams internalize the behavior, the market follows.
