...
keywords:
  ...
  - workflow
draft: true
description: Tools for Better Thinking as a signal about broader shifts.
created: 2020-05-28
updated: 2020-05-28
note_id: 200528TJ02
cssclasses:
...
Tools for Better Thinking surfaced as a high-signal public thread and points to a broader shift in how builders respond to the current cycle ([source](https://untools.co)). I see it as a hinge between immediate outcomes and longer-term incentives. The headline is not just the event but the behavior it reveals.

## context + claim
Tools for Better Thinking signals an engineering shift that will ripple through tooling and workflows. My claim: the technical change matters because it reshapes defaults more than it adds features.
