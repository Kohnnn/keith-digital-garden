...
<div class="keyword-row">
  ...
  <span class="inline-keyword">migration</span>
...
The other signal is energy exposure. Mining is not just computation; it is a power arbitrage. When a policy change cuts off cheap power, the economics flip. <span class="inline-claim">Energy policy is a protocol parameter</span> in practice, even if it lives outside the code.
...
<ul class="brain-dump">
  <li><strong>Policy:</strong> Regulation can move hardware faster than markets can.</li>
  <li><strong>Energy:</strong> Cheap power is the real substrate.</li>
  <li><strong>Risk:</strong> Geographic concentration is a silent vulnerability.</li>
  <li><strong>Logistics:</strong> Migration costs are real, not theoretical.</li>
  <li><strong>Resilience:</strong> Survival is not the same as stability.</li>
</ul>
...
## sources
> [!ref] BBC - China bans crypto mining
> https://www.bbc.com/news/technology-57501228
> Why it matters: Clear summary of the crackdown and immediate effect.

> [!ref] Reuters - China's crackdown on cryptocurrency mining: why it matters
> https://www.reuters.com/technology/chinas-crackdown-cryptocurrency-mining-why-it-matters-2021-06-25/
> Why it matters: Details the scope and the market response.
...
<div class="linkage-tree">
  ...
  <ul>
    ...
    <li>related
      <ul>
        <li>[[EIP-1559 and the Fee Burn]]</li>
