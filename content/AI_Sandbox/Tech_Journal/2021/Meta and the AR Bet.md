...
<ul class="brain-dump">
  <li><strong>Platform logic:</strong> Own the interface, own the market shape.</li>
  <li><strong>Compute weight:</strong> Every immersive feature is an ML and infra bill.</li>
  <li><strong>Trust debt:</strong> A new label does not erase old behavior.</li>
  <li><strong>Talent pull:</strong> Narrative clarity changes hiring flow.</li>
  <li><strong>Timing risk:</strong> Hardware cycles move slower than investor patience.</li>
</ul>
...
## sources
> [!ref] BBC - Facebook changes its name to Meta in major rebrand
> https://www.bbc.com/news/technology-59083601
> Why it matters: Clean summary of the strategic framing and market reception.

> [!ref] TechCrunch - Facebook will change its name to focus on the metaverse
> https://techcrunch.com/2021/10/19/facebook-reportedly-plans-to-change-its-name-to-focus-on-the-metaverse/
> Why it matters: Early framing before the official reveal.
