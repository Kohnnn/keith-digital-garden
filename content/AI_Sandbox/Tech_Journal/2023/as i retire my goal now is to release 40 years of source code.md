...
<div class="inline-ref">
  ...
  <a class="ref-link" href="https://dunfield.themindfactory.com/dnldsrc.htm">dunfield.themindfactory.com</a>
  <span class="ref-title">As I retire, my goal now is to release 40+ years of source code</span>
</div>

As I retire, my goal now is to release 40+ years of source code lands as a clean signal for the current cycle ([source](https://dunfield.themindfactory.com/dnldsrc.htm)). The point is not the news itself but the behavioral drift it exposes. I care about what becomes default after the dust settles.

## context + claim
as i retire, my goal now is to release 40+ years of source code shifts the center of gravity toward a new default. My claim is simple: this is a habit-forming change, not a one-off event. If teams internalize the behavior, the market follows.
