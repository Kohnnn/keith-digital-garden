...
Blender 4.0 release notes reads like a small event and a big signal at the same time ([source](https://wiki.blender.org/wiki/Reference/Release_Notes/4.0)). The point is not the headline, it is the behavioral drift it reveals. I care about what becomes default after the dust settles.

## context + claim
blender 4.0 release notes shifts the center of gravity toward a new default. My claim: this is a habit-forming change, not a one-off event. If teams internalize the behavior, the market follows.
