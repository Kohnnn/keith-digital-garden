...
<div class="inline-ref">
  ...
  <a class="ref-link" href="https://on.substack.com/p/notes">on.substack.com</a>
  <span class="ref-title">Substack Notes Launched</span>
</div>

Substack Notes Launched lands as a clean signal for the current cycle ([source](https://on.substack.com/p/notes)). The point is not the news itself but the behavioral drift it exposes. I care about what becomes default after the dust settles.

## context + claim
substack notes launched shifts the center of gravity toward a new default. My claim is simple: this is a habit-forming change, not a one-off event. If teams internalize the behavior, the market follows.
