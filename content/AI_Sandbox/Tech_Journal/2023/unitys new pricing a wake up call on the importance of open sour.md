...
<div class="inline-ref">
  ...
  <a class="ref-link" href="https://ramatak.com/2023/09/15/unitys-new-pricing-a-wake-up-call-on-the-importance-of-open-source-in-gaming/">ramatak.com</a>
  <span class="ref-title">Unity’s new pricing: A wake-up call on the importance of open source</span>
</div>

Unity’s new pricing: A wake-up call on the importance of open source lands as a clean signal for the current cycle ([source](https://ramatak.com/2023/09/15/unitys-new-pricing-a-wake-up-call-on-the-importance-of-open-source-in-gaming/)). The point is not the news itself but the behavioral drift it exposes. I care about what becomes default after the dust settles.

## context + claim
unity’s new pricing: a wake-up call on the importance of open source shifts the center of gravity toward a new default. My claim is simple: this is a habit-forming change, not a one-off event. If teams internalize the behavior, the market follows.
