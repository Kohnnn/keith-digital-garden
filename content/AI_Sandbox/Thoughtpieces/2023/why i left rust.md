...
<div class="inline-ref">
  ...
  <a class="ref-link" href="https://www.jntrnr.com/why-i-left-rust/">www.jntrnr.com</a>
  <span class="ref-title">Why I Left Rust</span>
</div>

Why I Left Rust lands as a clean signal for the current cycle ([source](https://www.jntrnr.com/why-i-left-rust/)). The point is not the news itself but the behavioral drift it exposes. I care about what becomes default after the dust settles.

## context + claim
why i left rust shifts the center of gravity toward a new default. My claim is simple: this is a habit-forming change, not a one-off event. If teams internalize the behavior, the market follows.
