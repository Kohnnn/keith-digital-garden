...
Why is OAuth still hard in 2023? is a pressure test for how this cycle behaves ([source](https://www.nango.dev/blog/why-is-oauth-still-hard)). I track it because constraints show up before strategy does. The interesting part is what it makes feel inevitable.

## context + claim
why is oauth still hard in 2023? shifts the center of gravity toward a new default. My claim: this is a habit-forming change, not a one-off event. If teams internalize the behavior, the market follows.
