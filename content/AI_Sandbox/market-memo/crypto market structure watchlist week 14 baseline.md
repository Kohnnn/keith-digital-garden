---
title: crypto market structure watchlist week 14 baseline
tags:
  - market-memo
  - crypto
  - structure
...
Each week I update:
1. All five dashboard metrics from current data.
2. Regime classification: healthy / fragile / stressed.
3. Key changes from prior week and whether they change the regime classification.
4. Handoff into the weekly market report: does the market structure read support, contradict, or modify the broader macro view?
