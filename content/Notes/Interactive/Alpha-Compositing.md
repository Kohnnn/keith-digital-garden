...
<div class="interactive-bridge-hero">
  ...
  <h2>Alpha Compositing now lives on the dedicated interactive site.</h2>
  <p>Pixel-accurate explanation of alpha blending and compositing math, from opacity/coverage to premultiplied alpha and filtering artifacts. This local page remains as a stable archive URL, but the maintained interactive experience is external.</p>
  <div class="kitchen-cta-row">
    <a class="kitchen-cta primary" href="https://kohnnn.github.io/interactive-explanation/alpha-compositing/" target="_blank" rel="noopener noreferrer">Open Alpha Compositing</a>
...
- Open the canonical interactive: <https://kohnnn.github.io/interactive-explanation/alpha-compositing/>
