...
<div class="interactive-bridge-hero">
  ...
  <h2>Exposing NSMutableArray now lives on the dedicated interactive site.</h2>
  <p>Interactive dynamic-array growth lab for reserve, multiplier, and reallocation behavior. This local page remains as a stable archive URL, but the maintained interactive experience is external.</p>
  <div class="kitchen-cta-row">
    <a class="kitchen-cta primary" href="https://kohnnn.github.io/interactive-explanation/exposing-nsmutablearray/" target="_blank" rel="noopener noreferrer">Open Exposing NSMutableArray</a>
...
- Open the canonical interactive: <https://kohnnn.github.io/interactive-explanation/exposing-nsmutablearray/>
