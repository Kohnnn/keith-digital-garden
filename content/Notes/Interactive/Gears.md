...
<div class="interactive-bridge-hero">
  ...
  <h2>Gears now lives on the dedicated interactive site.</h2>
  <p>Mechanical transmission explainer about angular velocity, torque transfer, involute tooth geometry, and multi-gear train behavior. This local page remains as a stable archive URL, but the maintained interactive experience is external.</p>
