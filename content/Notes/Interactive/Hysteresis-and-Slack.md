...
<div class="interactive-bridge-hero">
  ...
  <h2>Hysteresis & Slack now lives on the dedicated interactive site.</h2>
  <p>Interactive intuition-builder for hysteresis and mechanical slack showing path dependence, loops, and memory effects in input-output systems. This local page remains as a stable archive URL, but the maintained interactive experience is external.</p>
  <div class="kitchen-cta-row">
    <a class="kitchen-cta primary" href="https://kohnnn.github.io/interactive-explanation/hysteresis-and-slack/" target="_blank" rel="noopener noreferrer">Open Hysteresis & Slack</a>
...
- Open the canonical interactive: <https://kohnnn.github.io/interactive-explanation/hysteresis-and-slack/>
