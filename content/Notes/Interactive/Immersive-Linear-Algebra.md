...
<div class="interactive-bridge-hero">
  ...
  <h2>Immersive Linear Algebra now lives on the dedicated interactive site.</h2>
  <p>Immersive linear algebra learning site (access currently unavailable from this audit environment) intended to teach vectors, transforms, and geometric intuition interactively. This local page remains as a stable archive URL, but the maintained interactive experience is external.</p>
  <div class="kitchen-cta-row">
    <a class="kitchen-cta primary" href="https://kohnnn.github.io/interactive-explanation/immersive-linear-algebra/" target="_blank" rel="noopener noreferrer">Open Immersive Linear Algebra</a>
...
- Open the canonical interactive: <https://kohnnn.github.io/interactive-explanation/immersive-linear-algebra/>
