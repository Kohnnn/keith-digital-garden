...
<div class="interactive-bridge-hero">
  ...
  <h2>Lights and Shadows now lives on the dedicated interactive site.</h2>
  <p>Physically-based light transport explainer covering radiance, angle and distance falloff, reflection models, shadows, and multiple bounces. This local page remains as a stable archive URL, but the maintained interactive experience is external.</p>
  <div class="kitchen-cta-row">
    <a class="kitchen-cta primary" href="https://kohnnn.github.io/interactive-explanation/lights-and-shadows/" target="_blank" rel="noopener noreferrer">Open Lights and Shadows</a>
...
- Open the canonical interactive: <https://kohnnn.github.io/interactive-explanation/lights-and-shadows/>
