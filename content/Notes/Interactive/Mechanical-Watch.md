...
<div class="interactive-bridge-hero">
  ...
  <h2>Mechanical Watch now lives on the dedicated interactive site.</h2>
  <p>Comprehensive mechanical watch teardown: mainspring power flow, escapement timing, gear trains, keyless works, and automatic winding. This local page remains as a stable archive URL, but the maintained interactive experience is external.</p>
...
- Open the canonical interactive: <https://kohnnn.github.io/interactive-explanation/mechanical-watch/>
