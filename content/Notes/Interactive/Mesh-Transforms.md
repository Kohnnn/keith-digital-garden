...
<div class="interactive-bridge-hero">
  ...
  <h2>Mesh Transforms now lives on the dedicated interactive site.</h2>
  <p>Interactive affine transform lab for rotation, scaling, shear order, and grid deformation. This local page remains as a stable archive URL, but the maintained interactive experience is external.</p>
  <div class="kitchen-cta-row">
    <a class="kitchen-cta primary" href="https://kohnnn.github.io/interactive-explanation/mesh-transforms/" target="_blank" rel="noopener noreferrer">Open Mesh Transforms</a>
...
- Open the canonical interactive: <https://kohnnn.github.io/interactive-explanation/mesh-transforms/>
