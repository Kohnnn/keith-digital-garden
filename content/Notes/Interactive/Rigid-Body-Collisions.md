...
<div class="interactive-bridge-hero">
  ...
  <h2>Rigid Body Collisions now lives on the dedicated interactive site.</h2>
  <p>Physics/math explainer for 2D rigid-body collision resolution with vector geometry, normals, and relative-velocity intuition. This local page remains as a stable archive URL, but the maintained interactive experience is external.</p>
  <div class="kitchen-cta-row">
    <a class="kitchen-cta primary" href="https://kohnnn.github.io/interactive-explanation/rigid-body-collisions/" target="_blank" rel="noopener noreferrer">Open Rigid Body Collisions</a>
...
- Open the canonical interactive: <https://kohnnn.github.io/interactive-explanation/rigid-body-collisions/>
