...
<div class="interactive-bridge-hero">
  ...
  <p>
    ...
    then move into iterated rounds where reputation, noise, and forgiveness shape outcomes. It makes
    abstract game-theory mechanics feel concrete.
  </p>
...
<div class="casefile-summary">
  <div>
    ...
    <p>Cooperation is fragile. This sim makes it easy to see how noise, miscommunication, and short time horizons push systems toward defection — and how repeated interactions repair them.</p>
  </div>
  <div>
...
<div class="external-canvas-wrap">
  <iframe
    src="https://kohnnn.github.io/interactive-explanation/trust/"
    title="The Evolution of Trust interactive"
    loading="lazy"
    allow="fullscreen"
