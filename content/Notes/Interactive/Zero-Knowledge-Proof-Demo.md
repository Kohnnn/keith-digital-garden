...
<div class="interactive-bridge-hero">
  ...
  <p>
    ...
    and watch how repeated verification builds confidence without exposing the underlying secret
    path. It shifts the lesson from authenticity to privacy.
  </p>
...
<div class="casefile-summary">
  <div>
    ...
    <p>Zero-knowledge proofs sound abstract. This makes the core idea — proving something without revealing the underlying data — interactive and playful.</p>
  </div>
  <div>
...
<div class="external-canvas-wrap">
  <iframe
    src="https://kohnnn.github.io/interactive-explanation/zero-knowledge-proof-demo/"
    title="Zero-Knowledge Proof Demo interactive"
    loading="lazy"
    allow="fullscreen"
