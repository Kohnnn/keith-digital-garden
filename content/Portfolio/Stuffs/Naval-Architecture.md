...
Use balanced load and density to establish a baseline draft equilibrium.

<div class="interactive-sim interactive-sim-secondary" data-sim-scene="naval-architecture">
  <div class="interactive-sim-stage stage-medium">
    <canvas class="sim-canvas" aria-label="Naval architecture buoyancy simulator"></canvas>
  </div>
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>payload load</label>
      <input data-control="load" type="range" min="0" max="2" step="0.01" value="1" />
    </div>
    <div class="interactive-sim-control">
      <label>fluid density</label>
      <input data-control="density" type="range" min="0.3" max="2" step="0.01" value="1.15" />
    </div>
...
Lower payload and density to inspect shallow-immersion behavior.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="naval-architecture">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>payload load</label>
      <input data-control="load" type="range" min="0" max="2" step="0.01" value="0.4" />
    </div>
    <div class="interactive-sim-control">
      <label>fluid density</label>
      <input data-control="density" type="range" min="0.3" max="2" step="0.01" value="0.55" />
    </div>
...
Raise payload and density to examine deeper draft under stronger buoyant support.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="naval-architecture">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>payload load</label>
      <input data-control="load" type="range" min="0" max="2" step="0.01" value="1.6" />
    </div>
    <div class="interactive-sim-control">
      <label>fluid density</label>
      <input data-control="density" type="range" min="0.3" max="2" step="0.01" value="1.74" />
    </div>
...
Mix lower density with moderate load to separate fluid effects from mass effects.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="naval-architecture">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>payload load</label>
      <input data-control="load" type="range" min="0" max="2" step="0.01" value="0.6" />
    </div>
    <div class="interactive-sim-control">
      <label>fluid density</label>
      <input data-control="density" type="range" min="0.3" max="2" step="0.01" value="1.57" />
    </div>
...
Push near-limit balance conditions to stress sink/float transition intuition.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="naval-architecture">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>payload load</label>
      <input data-control="load" type="range" min="0" max="2" step="0.01" value="0.1" />
    </div>
    <div class="interactive-sim-control">
      <label>fluid density</label>
      <input data-control="density" type="range" min="0.3" max="2" step="0.01" value="1.92" />
    </div>
...
Run a sustained mid-high scenario and compare equilibrium stability under small adjustments.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="naval-architecture">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>payload load</label>
      <input data-control="load" type="range" min="0" max="2" step="0.01" value="1.2" />
    </div>
    <div class="interactive-sim-control">
      <label>fluid density</label>
      <input data-control="density" type="range" min="0.3" max="2" step="0.01" value="1.41" />
    </div>
