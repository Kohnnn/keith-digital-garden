...
Use moderate frequency, amplitude, and damping for a waveform baseline.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="sound">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      ...
      <input data-control="frequency" type="range" min="0.4" max="8" step="0.05" value="4.2" />
    </div>
    <div class="interactive-sim-control">
      <label>amplitude</label>
      <input data-control="amplitude" type="range" min="0.1" max="1" step="0.01" value="0.55" />
    </div>
    <div class="interactive-sim-control">
      <label>damping</label>
      <input data-control="damping" type="range" min="0" max="5" step="0.05" value="2.5" />
    </div>
...
Lower frequency and damping to inspect long, slowly fading oscillations.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="sound">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>frequency</label>
      <input data-control="frequency" type="range" min="0.4" max="8" step="0.05" value="1.9" />
    </div>
    <div class="interactive-sim-control">
      <label>amplitude</label>
      <input data-control="amplitude" type="range" min="0.1" max="1" step="0.01" value="0.24" />
    </div>
    <div class="interactive-sim-control">
      <label>damping</label>
      <input data-control="damping" type="range" min="0" max="5" step="0.05" value="1" />
    </div>
...
Raise frequency and damping to examine dense waves with faster envelope decay.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="sound">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>frequency</label>
      <input data-control="frequency" type="range" min="0.4" max="8" step="0.05" value="6.5" />
    </div>
    <div class="interactive-sim-control">
      <label>amplitude</label>
      <input data-control="amplitude" type="range" min="0.1" max="1" step="0.01" value="0.87" />
    </div>
    <div class="interactive-sim-control">
      <label>damping</label>
      <input data-control="damping" type="range" min="0" max="5" step="0.05" value="4" />
    </div>
...
Mix low amplitude with higher frequency to separate loudness cues from oscillation density.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="sound">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>frequency</label>
      <input data-control="frequency" type="range" min="0.4" max="8" step="0.05" value="2.7" />
    </div>
    <div class="interactive-sim-control">
      <label>amplitude</label>
      <input data-control="amplitude" type="range" min="0.1" max="1" step="0.01" value="0.78" />
    </div>
    <div class="interactive-sim-control">
      <label>damping</label>
      <input data-control="damping" type="range" min="0" max="5" step="0.05" value="2" />
    </div>
...
Use near-edge parameter values to stress waveform readability and decay behavior.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="sound">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>frequency</label>
      <input data-control="frequency" type="range" min="0.4" max="8" step="0.05" value="0.8" />
    </div>
    <div class="interactive-sim-control">
      <label>amplitude</label>
      <input data-control="amplitude" type="range" min="0.1" max="1" step="0.01" value="0.96" />
    </div>
    <div class="interactive-sim-control">
      <label>damping</label>
      <input data-control="damping" type="range" min="0" max="5" step="0.05" value="4.75" />
    </div>
...
Run mid-high settings and compare long-run envelope stability across sweeps.
...
<div class="interactive-sim interactive-sim-secondary" data-sim-scene="sound">
  ...
  <div class="interactive-sim-controls">
    <div class="interactive-sim-control">
      <label>frequency</label>
      <input data-control="frequency" type="range" min="0.4" max="8" step="0.05" value="4.95" />
    </div>
    <div class="interactive-sim-control">
      <label>amplitude</label>
      <input data-control="amplitude" type="range" min="0.1" max="1" step="0.01" value="0.69" />
    </div>
    <div class="interactive-sim-control">
      <label>damping</label>
      <input data-control="damping" type="range" min="0" max="5" step="0.05" value="2.75" />
    </div>
