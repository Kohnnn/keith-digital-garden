...
<div class="portfolio-route-board">
  <a class="portfolio-route-card portfolio-route-card--primary" href="./Projects">
    ...
    <ul class="portfolio-route-points">
      ...
      <li><strong>Option pricing and AI workflows</strong> show model explainability, local RAG, monitoring, and publishing infrastructure.</li>
    </ul>
    <div class="portfolio-chip-row">
      <span>VNIBB</span>
      <span>Cycle playbook</span>
...
<div class="writing-grid">
  <a class="writing-card" href="./Profile">
    ...
    <h3>Profile</h3>
    <p>See how consumer coverage, crypto market work, Vietnam-market products, and research automation fit together as one operating profile.</p>
  </a>
  <a class="writing-card" href="./Skills">
    <span class="casefile-label">Capability shelf</span>
    <h3>Skills</h3>
    <p>Financial analysis, blockchain research, quantitative finance, and business-intelligence tools grouped by the work they actually unlock.</p>
  </a>
</div>
...
<div class="portfolio-loop-grid">
  <div class="portfolio-loop-card">
    ...
    <p>Track company updates, BTC structure, market breadth, and macro pressure with monitors, dashboards, and recurring notes.</p>
    <span class="portfolio-loop-meta">Outputs: coverage checks, dashboard reads, weekly market updates</span>
  </div>
  <div class="portfolio-loop-card">
    <span class="portfolio-loop-step">02</span>
    <strong>Interpret</strong>
    <p>Turn raw information into explicit thesis language, model updates, phase calls, and risk cues that can survive review.</p>
    <span class="portfolio-loop-meta">Outputs: recommendation support, framework notes, pricing assumptions</span>
  </div>
  <div class="portfolio-loop-card">
    <span class="portfolio-loop-step">03</span>
    <strong>Build</strong>
    <p>Ship surfaces that reduce research drag: VNIBB, the crypto dashboard, the option-pricing app, and AI-assisted monitoring workflows.</p>
    <span class="portfolio-loop-meta">Outputs: products, dashboards, automation, implementation docs</span>
  </div>
  <div class="portfolio-loop-card">
    <span class="portfolio-loop-step">04</span>
    <strong>Reuse</strong>
    <p>Fold every output back into casefiles, operating notes, and the next review cycle so the work compounds instead of disappearing.</p>
    <span class="portfolio-loop-meta">Outputs: casefiles, research notes, reusable templates</span>
  </div>
</div>
