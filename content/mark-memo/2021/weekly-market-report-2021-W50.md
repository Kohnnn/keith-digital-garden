---
title: Weekly Market Report 2021-W50
...
note_id: 211213MR01
draft: true
description: Fresh inflation data kept policy pressure high into year-end.
created: 2021-12-13
updated: 2021-12-19
---

# Weekly Market Report 2021-W50

*see also:* [[weekly-market-report-2021-W49]] · [[weekly-market-report-2021-W21]]

<div class="keyword-row">
  <span class="inline-keyword">scarcity</span>
  <span class="inline-keyword">momentum</span>
  <span class="inline-keyword">risk</span>
  <span class="inline-keyword">discipline</span>
  <span class="inline-keyword">power</span>
</div>

I read this week as year-end momentum under inflation pressure. I avoided broad conviction because the tape still showed strong headline moves with uneven internal confirmation. Instead of chasing direction, I stayed with process: identify the regime, map invalidation, and only then add risk.
...
My anchor set stayed constant: cpi remained hot into december, equities pushed through with uneven participation quality, and crypto struggled to hold rebounds against tightening fears. If those signals aligned, I allowed more conviction; if they diverged, I protected capital first.
...
> [!note] Market Pulse
> "Late-year momentum needs macro permission, not just flow."
...
## References
> [!ref] BLS CPI News Release (Dec 2021)
...
> [!ref] Federal Reserve - FOMC Statement (Dec 15, 2021)
...
> [!ref] BIS Quarterly Review (Dec 2021)
...
> [!ref] Reuters - Bitcoin futures ETF launch context
...
## Cross Review
- Linked from: [[weekly-market-report-2021-W51]] - Follow-up week re-tested this regime transition.
...
<div class="linkage-tree">
  ...
  <ul>
    ...
    <li>weekly chain
      <ul>
        <li>[[weekly-market-report-2021-W49]]</li>
      </ul>
    </li>
  </ul>
</div>
