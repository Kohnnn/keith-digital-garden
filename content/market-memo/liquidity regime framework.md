---
title: liquidity regime framework
tags:
  - market-memo
  - macro
  - liquidity
...
1. **Rates** move first — front-end follows the policy signal, long-end follows growth expectations.
2. **Credit spreads** confirm or reject the rates read. Tightening that doesn't widen spreads is either not real yet or being offset by something else.
3. **Risk appetite** follows credit confirmation, usually with a lag of days to weeks.
4. **Liquidity-sensitive assets** (crypto, EM, small-caps) are last to confirm and first to reverse.
